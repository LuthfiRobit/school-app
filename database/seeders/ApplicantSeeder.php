...
class ApplicantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 4. Applicant 4 — Ahmad Fauzi (untuk test FINALISASI: status = settled)
        DB::table('applicants')->insert([
            'user_id'        => null,
            ...
            'phone'          => '084567890123',
            'parent_name'    => 'Fauzan',
            'parent_phone'   => '084567890124',
            'address'        => 'Jl. Kaliurang No. 15, Yogyakarta',
            'created_by'     => $adminId,
            'created_at'     => $now,
            'updated_at'     => $now,
        ]);

        // 5. Applicant 5 — Dewi Rahayu (untuk test DOWNLOAD SURAT: status = permanent_student)
        DB::table('applicants')->insert([
            'user_id'        => null,
            ...
            'phone'          => '085678901234',
            'parent_name'    => 'Rahmat',
            'parent_phone'   => '085678901235',
            'address'        => 'Jl. Pandanaran No. 22, Semarang',
            'created_by'     => $adminId,
            'created_at'     => $now,
            'updated_at'     => $now,
        ]);
