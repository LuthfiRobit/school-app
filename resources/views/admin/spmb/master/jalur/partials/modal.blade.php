    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light">
                <h5 class="modal-title"><i class="ti ti-info-circle me-2"></i>Detail Jalur Pendaftaran</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" x-show="detailData">
                <div class="mb-3 text-center">
                    <label class="small text-muted d-block mb-1">Nama Jalur Pendaftaran</label>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-borderless">
                        <tr>
                            <td width="150" class="fw-bold text-muted">Slug</td>
                            <td>: <span class="badge bg-light-primary text-primary" x-text="detailData?.slug"></span></td>
                        </tr>
                        <tr>
