            ...
            <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                    <div class="mt-3 row align-items-center">
                        <div class="col-12">
                            <h5 class="mb-1" x-text="formatNumber(kpi.total_pendaftar)">0</h5>
                            <p class="text-primary mb-0"><i class="ti ti-calendar-event"></i> Tahun Ajaran Terpilih</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                    <div class="mt-3 row align-items-center">
                        <div class="col-12">
                            <h5 class="mb-1" x-text="formatNumber(kpi.total_lulus)">0</h5>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="mb-0">Siswa Tetap</h6>
                    </div>
                </div>
                <div class="bg-body p-3 mt-3 rounded">
                    <div class="mt-3 row align-items-center">
                        <div class="col-12">
                            <h5 class="mb-1" x-text="formatNumber(kpi.total_siswa_tetap)">0</h5>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                    <div class="mt-3 row align-items-center">
                        <div class="col-12">
                            <h5 class="mb-1" x-text="formatCurrency(kpi.total_penerimaan)">Rp 0</h5>
