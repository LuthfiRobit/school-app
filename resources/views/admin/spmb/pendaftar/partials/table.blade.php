<div class="col-12">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h5 class="mb-0 text-primary"><i class="ti ti-filter me-2"></i>Filter Pendaftar</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="ti ti-list me-2"></i>Daftar Pendaftar</h5>
            <div class="d-flex gap-2">
                <div x-show="selectedIds.length > 0" x-transition x-cloak>
                    <div class="d-flex gap-2 me-2 border-end pe-3">
                        <button class="btn btn-sm btn-primary" @click="openBulkStatusModal">
                            <i class="ti ti-arrows-left-right me-1"></i> Ubah Status Massal (<span x-text="selectedIds.length"></span>)
                        </button>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="enrollmentTable" class="table table-hover w-100 align-middle">
