<div class="card shadow-sm border-0 mb-4">
  <div class="card-body p-4">
    <h5 class="fw-bold text-primary-900 mb-3">
      <i class="fa-solid fa-clock-rotate-left me-2 text-primary-600"></i> Riwayat Pembayaran Uang Pangkal
    </h5>
    
    @if($payments->isEmpty())
      <div class="text-center py-4">
        <div class="text-muted mb-2"><i class="fa-solid fa-receipt fs-2"></i></div>
        <h6 class="fw-semibold text-primary-900 small mb-0">Belum ada riwayat cicilan</h6>
        <p class="text-muted text-xxs mb-0 mt-1">Silakan lakukan transfer dan unggah bukti transfer cicilan Anda.</p>
      </div>
    @else
