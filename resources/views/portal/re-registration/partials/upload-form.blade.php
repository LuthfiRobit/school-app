<div class="card shadow-sm border-0 mb-4" x-data="uploadPaymentForm()">
  <div class="card-body p-4">
    <h5 class="fw-bold text-primary-900 mb-3">
      <i class="fa-solid fa-cloud-arrow-up me-2 text-primary-600"></i> Unggah Bukti Pembayaran
    </h5>
    
    <!-- Peringatan jika pengisian terakhir ditolak -->
    @php
    ...
    <form action="{{ route('portal.re-registration.upload', $enrollment->id) }}" method="POST" enctype="multipart/form-data" @submit="loading = true">
      @csrf
      
      <!-- Area Upload Bukti Pembayaran -->
      <div class="mb-4">
        <label class="form-label small fw-bold text-primary-800">Pilih Berkas Bukti Transfer <span class="text-danger">*</span></label>
      ...
      <div class="mb-4">
        ...
        <div class="text-muted text-xxs mt-1.5"><i class="fa-solid fa-circle-info me-1"></i> Masukkan nominal persis seperti yang tertera pada bukti transfer.</div>
